...
import { ArrowUpRight, TrendingUp, Users, Search } from "lucide-react";
...
export default function CaseStudiesPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-border/40 px-4 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-32">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,oklch(0.55_0.18_155/0.15),transparent)]" />
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <motion.h1
            ...
            className="mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl"
          >
          ...
          <motion.p
            ...
            className="mx-auto mt-4 max-w-2xl text-sm text-muted-foreground sm:mt-6 sm:text-base"
          >
              ...
              <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h2 className="text-xl font-bold text-foreground sm:text-2xl">{c.title}</h2>
                    </div>
                  </div>
                ...
                <div className="flex shrink-0 gap-3 sm:gap-4">
                  {c.metrics.map((m) => (
                    ...
                    >
                      <span className="text-lg font-black text-primary sm:text-xl">{m.value}</span>
