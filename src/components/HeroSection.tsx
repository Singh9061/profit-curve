    ...
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden pt-16 sm:pt-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(0.18 0.05 155 / 0.6) 0%, transparent 60%), linear-gradient(180deg, oklch(0.12 0.025 155) 0%, oklch(0.10 0.02 155) 100%)",
          }}
        />
        ...
        <motion.div
          ...
          className="absolute left-1/4 top-1/4 h-56 w-56 rounded-full bg-primary/20 blur-[90px] sm:h-80 sm:w-80 sm:blur-[110px] lg:h-[28rem] lg:w-[28rem] lg:blur-[130px]"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 right-1/4 h-48 w-48 rounded-full bg-[oklch(0.55_0.15_145)]/15 blur-[70px] sm:h-64 sm:w-64 sm:blur-[90px] lg:h-80 lg:w-80 lg:blur-[110px]"
        />
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 text-center sm:px-6">
        ...
        >
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[0_0_30px_oklch(0.55_0.18_155/0.3)] transition-all hover:scale-105 hover:shadow-[0_0_50px_oklch(0.55_0.18_155/0.5)] sm:w-auto sm:px-8 sm:py-4 sm:text-base"
          >
