      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 text-center sm:px-6">
        ...
        >
          <a
            ...
            className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full px-6 py-3.5 text-sm font-semibold text-primary-foreground sm:w-auto sm:px-8 sm:py-4 sm:text-base"
          >
            {/* Glass background */}
            <span className="absolute inset-0 rounded-full bg-primary/90 backdrop-blur-md transition-all duration-300 group-hover:bg-primary" />
            <span className="absolute inset-0 rounded-full shadow-[0_0_40px_oklch(0.55_0.18_155/0.4)] transition-all duration-300 group-hover:shadow-[0_0_60px_oklch(0.55_0.18_155/0.6)]" />
          ...
          <motion.a
            ...
            className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full px-6 py-3.5 text-sm font-semibold text-primary sm:w-auto sm:px-8 sm:py-4 sm:text-base"
          >
            {/* Glass border button */}
            ...
            <span className="absolute inset-0 rounded-full shadow-[0_0_20px_oklch(0.55_0.18_155/0.15)] transition-all duration-300 group-hover:shadow-[0_0_35px_oklch(0.55_0.18_155/0.3)]" />
