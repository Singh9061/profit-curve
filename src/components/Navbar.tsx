          ...
          >
            <div className="flex flex-col gap-4 px-4 py-6 sm:px-6">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <a href="https://wa.me/918005150056" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium text-primary">
                  Chat on WhatsApp
                </a>
                <a href="https://www.instagram.com/the_raebarelian?igsh=bHBpaTd4eWt4NmNs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium text-primary">
                  Instagram
                </a>
                <a href="tel:+918005150056" className="flex items-center gap-2 text-sm font-medium text-primary">
                  <Phone className="h-4 w-4" />
                  Call Now
                </a>
              </div>
